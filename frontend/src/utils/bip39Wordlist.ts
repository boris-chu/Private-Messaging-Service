...
export const BIP39_WORDLIST: readonly string[] = [
  ...
  'bench', 'benefit', 'best', 'better', 'between', 'beyond', 'bicycle', 'bid',
  'bike', 'bind', 'biology', 'bird', 'birth', 'bitter', 'black', 'blade',
  'blame', 'blanket', 'blast', 'bleak', 'bless', 'blind', 'blood', 'blossom',
  'blouse', 'blue', 'blur', 'board', 'boat', 'body', 'boil', 'bomb',
  ...
  'buddy', 'budget', 'buffalo', 'build', 'bulk', 'bundle', 'bunker', 'burden',
  'burger', 'burst', 'bus', 'business', 'busy', 'butter', 'buyer', 'buzz',
  'bypass', 'byte', 'cabin', 'cable', 'cactus', 'cage', 'cake', 'calcium',
  'calendar', 'calf', 'call', 'calm', 'camel', 'camera', 'camp', 'campus',
  ...
  'ceiling', 'celery', 'cement', 'census', 'center', 'century', 'cereal', 'certain',
  ...
  'clarify', 'class', 'classic', 'clay', 'clean', 'clerk', 'clever', 'click',
  ...
  'combine', 'come', 'comfort', 'comic', 'common', 'company', 'compare', 'compete',
  'compile', 'concert', 'conduct', 'confirm', 'congress', 'connect', 'consider', 'control',
  ...
  'distance', 'divide', 'dizzy', 'doctor', 'document', 'dog', 'doll', 'dolphin',
  'domain', 'donate', 'donkey', 'donor', 'door', 'dose', 'double', 'dove',
  'down', 'draft', 'dragon', 'drama', 'draw', 'dream', 'dress', 'drift',
  'drill', 'drink', 'drive', 'drop', 'drum', 'dry', 'duck', 'dumb',
  'dune', 'during', 'dust', 'duty', 'dwarf', 'dynamic', 'eager', 'eagle',
  ...
  'flee', 'flight', 'flip', 'float', 'flock', 'flood', 'floor', 'flower',
  ...
  'grant', 'grape', 'graph', 'grass', 'gravity', 'great', 'green', 'grid',
  'grief', 'grill', 'grin', 'grocery', 'gross', 'ground', 'group', 'grow',
  ...
  // H words (128 words)
  'health', 'heart', 'heavy', 'hedge', 'height', 'hello', 'helmet', 'help',
  'hen', 'hero', 'hidden', 'high', 'hill', 'hint', 'hip', 'hire',
  'history', 'hobby', 'hockey', 'hold', 'hole', 'holiday', 'hollow', 'home',
  'honey', 'hood', 'hope', 'horn', 'horse', 'hospital', 'host', 'hotel',
  ...
  'layer', 'lazy', 'leader', 'leaf', 'league', 'lean', 'learn', 'lease',
  'leather', 'leave', 'lecture', 'left', 'leg', 'legal', 'legend', 'leisure',
  'lemon', 'lend', 'length', 'lens', 'leopard', 'lesson', 'letter', 'level',

  // L words (64 words)
  'liar', 'liberty', 'library', 'license', 'life', 'lift', 'light', 'like',
  'limb', 'limit', 'line', 'link', 'lion', 'liquid', 'list', 'listen',
  ...
  // O words (64 words)
  'ozone', 'pace', 'pacific', 'pack', 'package', 'page', 'pair', 'palace',
  ...
  'pull', 'pulse', 'pumpkin', 'punch', 'pupil', 'puppy', 'purchase', 'purity',
  ...
  'rural', 'rush', 'sad', 'saddle', 'sadness', 'safe', 'sail', 'salad',
  ...
  // Final words to reach 2048
  'vice', 'victim', 'video', 'view', 'village', 'vintage', 'violin', 'virtual',
...
if (BIP39_WORDLIST.length !== 2048) {
  console.error(`Warning: Wordlist has ${BIP39_WORDLIST.length} words, expected 2048`);
}

export const WORDLIST_SIZE = BIP39_WORDLIST.length;